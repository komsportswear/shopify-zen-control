...
const faqs = [
  ...
  },
  {
    ...
    answer: "El proceso suele tomar entre 1 a 5 días hábiles desde que recibimos tu aplicación completa. Nos comunicaremos contigo si encontramos afinidad comercial.",
  },
  {
