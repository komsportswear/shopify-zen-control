          ...
          <div className="space-y-10">
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                En KOM buscamos distribuidores que quieran construir una relación comercial seria, con foco en experiencia de marca, venta consultiva y crecimiento sostenido.
              </p>
            </div>
